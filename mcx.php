<?php
// https://wixo.herokuapp.com/mc.php?co=aHR0cHM6Ly9teWNpbWFhLmZ1bi93YXRjaC8lZDklODUlZDglYjQlZDglYTclZDklODclZDglYWYlZDglYTktJWQ5JTgxJWQ5JThhJWQ5JTg0JWQ5JTg1LXRoZS1teXN0ZXJpb3VzLXN0b3J5LW9mLWxvbmd5dW4tdG93bi0yMDIyLSVkOSU4NSVkOCVhYSVkOCViMSVkOCVhYyVkOSU4NS8=
...
foreach ($dom->getElementsByTagName('ul') as $div) {
     if($div->getattribute('class') == 'List--Download--Mycima--Single') {
          ...
          foreach($div->getElementsByTagName('a') as $link) {  
            ...
            echo '<div class="see-btn"  style="margin-top: 10px;width: 320px;display: inline-block;"><a target="_blank" href="'.$url.'"><i class="fa fa-cloud-download"></i> تحميل بجودة '.$num.'<a/></div><br/>';
